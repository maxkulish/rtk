...
fn join_with_overflow(items: &[String], total: usize, max: usize, label: &str) -> String {
...
fn truncate_iso_date(date: &str) -> &str {
    // Truncate ISO8601 date: "2024-01-15T10:30:00Z" -> "2024-01-15"
