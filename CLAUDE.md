...
```bash
rtk --version  # Should show "rtk 0.30.0" (or newer) <!-- x-release-please-version -->
...
| utils.rs | Shared utilities | Package manager detection, common formatting, stdin forwarding |
